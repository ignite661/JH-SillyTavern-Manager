...
echo -e "\033[1;33m为Android Termux设计\033[0m"
echo "======================================"
echo -e "\033[1;35m作者: 纪贺（还有cursor！）\033[0m"
echo "======================================"
...
function show_header() {
    clear
    echo -e "\033[1;36m纪贺的SillyTavern管理助手\033[0m"
    echo -e "\033[0;33m因为有些人不看公告故怒出脚本 - 由纪贺精心打造\033[0m"
    echo "======================================"
}
